...
tags = {
	names  = { 	"www", 		"code", 	"mume", 		"etc",        	 },
	layout = {  layouts[2], layouts[2], layouts[11], layouts[10]
}}
for s = 1, screen.count() do
...
for s = 1, screen.count() do
    ...
    myawesomewibox[s] = awful.wibox({ position = "bottom", screen = s })
    ...
    myawesomewibox[s]:set_widget(myawesomelayout)
